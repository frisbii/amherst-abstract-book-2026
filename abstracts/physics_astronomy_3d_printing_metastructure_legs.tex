\makeabstract
    ...
    {
    William Sober\textsuperscript{1}, Mingzhao Li\textsuperscript{2}, Ya Tang\textsuperscript{2}, Professor Yan Li\textsuperscript{2}
    }
    {
...
\textsuperscript{2} Thayer School of Engineering at Dartmouth College, Hanover, NH
    ...
    {
    Global energy use is rising unsustainably, with excessive energy being lost as wasted heat in settings like data centers, automobile exhaust, and power plants. Thermoelectric generators (TEGs) make electricity from heat, and could recover this wasted energy on a large scale. However, current state-of-the art models suffer from high manufacturing costs and low efficiency. The goal of this project is to develop an optimal procedure and formulation to 3D print high-solid-loading (90 weight\%) Bi0.5Sb1.5Te3 metastructure legs for use in a high-efficiency thermoelectric generator using direct ink writing (DIW). 
    }
    {
