\makeabstract
    {
    Exploring the Photophysics of Mn$^{2+}$ Dopant in ZnSe QD System
    }
    {
    ...
    {
    The observations from this study demonstrate potential in synthesizing a broader series of Mn:ZnSe QDs with different Mn$^{2+}$ doping percentages. Beyond just characterization, we also aim to determine the electron transfer rate, through methods such as quenching or shelling, and photophysics of Mn:ZnSe QDs.
    }
